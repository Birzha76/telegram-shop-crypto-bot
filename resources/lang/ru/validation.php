...
return [
    ...
    'custom' => [
        'ref_1.*' => [
            'unique' => 'Пользователь :attribute уже является рефералом 1-го уровня',
        ],
        'ref_2.*' => [
            'unique' => 'Пользователь :attribute уже является рефералом 2-го уровня',
        ],
        'ref_3.*' => [
            'unique' => 'Пользователь :attribute уже является рефералом 3-го уровня',
        ],
    ],
];
